...
const GENERATE_TEXT = 'LIBNAME.is_node = typeof require !== "undefined";\nLIBNAME.is_rhino = typeof load !== "undefined";\n\nLIBNAME.zprint = function(x){\n    if (LIBNAME.is_node){\n        console.log(x);\n    }else if (LIBNAME.is_rhino){\n        print(x);\n    }else{\n        console.log(x);\n    }\n}\n\n\n\nLIBNAME.line = 1;\nLIBNAME.current_input = null;\nLIBNAME.old_input = null;\nLIBNAME.input = null;\n\nLIBNAME.set_input = function(input){\n    LIBNAME.input = input;\n    LIBNAME.old_input = null;\n    LIBNAME.current_input = null;\n}\n\n\n\n\nLIBNAME.lex = function(){\n    if (!LIBNAME.old_input || LIBNAME.old_input != LIBNAME.input){\n        LIBNAME.old_input = LIBNAME.input;\n        LIBNAME.current_input = LIBNAME.old_input;\n    }\n    \n    var input = LIBNAME.current_input;\n    var match_length = 0;\n    var match_index = 0;\n    var match_string = 0;\n    while (input.length){\n        for (var i=0;i<LIBNAME.regex_list.length;i++){\n            var ma = input.match(LIBNAME.regex_list[i]);\n            if (ma){\n                if (match_length < ma[0].length){\n                    match_length = ma[0].length;\n                    match_index = i;\n                    match_string = ma[0];\n                }\n            }\n        }\n        \n        if (match_length){\n            for (var i=0;i<match_length;i++){\n                if (LIBNAME.current_input[i] == "\\n"){\n                    LIBNAME.line++;\n                }\n            }\n\n            LIBNAME.current_input = LIBNAME.current_input.substring(match_length);\n            return LIBNAME.do_list[match_index](match_string,LIBNAME.line);\n        }\n        \n        if (LIBNAME.current_input[0] == "\\n"){\n            LIBNAME.line++;\n        }\n\n        LIBNAME.current_input = LIBNAME.current_input.substring(1);\n        input = LIBNAME.current_input;\n    }\n\n    \n    \n    return null;\n}'
